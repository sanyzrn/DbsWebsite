  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden section-pad border-t border-line">
        ...
        <Reveal delay={60}>
          <header className="mx-auto mt-10 max-w-[70ch]">
            ...
            <h1 className="display-heading mt-5 text-[32px] font-semibold leading-[1.18] tracking-tight md:text-[46px] md:leading-[1.12]">{fm.title}</h1>
            <p className="mt-6 text-[17px] font-medium leading-9 text-ink2 md:text-[18px]">{fm.description}</p>
            {fm.tags.length > 0 ? (
              <p className="mt-6 border-t border-line pt-5 font-mono text-[11px] font-semibold uppercase tracking-[0.16em] text-ink3">
                {fm.tags.join(" · ")}
              </p>
            ) : null}
          </header>
        ...
        <Reveal delay={120}>
          <div className="article-prose mx-auto mt-12 max-w-[70ch]">
        ...
        {relatedProjects.length > 0 ? (
          <Reveal delay={180}>
            <aside className="mx-auto mt-16 max-w-[70ch] border-t border-line pt-10">
              <h2 className="font-mono text-[10.5px] font-semibold uppercase tracking-[0.2em] text-ink3">{t.articles.relatedProjects}</h2>
          ...
          <Reveal delay={180}>
            <aside className="mx-auto mt-16 max-w-[70ch] border-t border-line pt-10">
              <h2 className="font-mono text-[10.5px] font-semibold uppercase tracking-[0.2em] text-ink3">{t.articles.pageTitle}</h2>
              <ul className="mt-4 space-y-3">
