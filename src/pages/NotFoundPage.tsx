      ...
      >
        ...
        <div className="relative z-[1] section-pad">
          <div className="wrap max-w-2xl text-center">
            <Reveal>
              <p
                className="nf-mark hero-brand-name text-[88px] leading-none sm:text-[120px] md:text-[140px]"
                aria-hidden="true"
                dir="ltr"
              >
              ...
              <h1 className="display-heading mt-7 text-[28px] font-semibold tracking-tight text-ink sm:mt-8 sm:text-[32px] md:text-[40px]">
                {copy.title}
              </h1>
              <p className="mx-auto mt-5 max-w-lg text-[15px] leading-8 text-ink2">{copy.body}</p>
              <Link to={localePath(lang, "/")} className="btn btn-primary mt-9 inline-flex">
                {copy.home}
              </Link>
            </Reveal>
          </div>
