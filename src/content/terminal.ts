...
const FA_COMMANDS: Record<Exclude<TerminalCommandId, 'clear'>, string[]> = {
  help: [
    ...
    '│  whoami / کیستم    — نمایش نمایهٔ کاربر',
    '│  skills / مهارت‌ها  — فهرست توانمندی‌های فنی',
    '│  projects / پروژه‌ها — مرور کارهای منتخب',
    '│  contact / تماس    — اطلاعات تماس',
    '│  coffee / قهوه     — سوخت ضروری کار',
  ...
  whoami: [
    ...
    '  پایگاه   استودیوی مستقل — آمادهٔ همکاری دورکار',
    '  شیوه     دقت و خلاقیت',
    '',
    '  «برای نمایش طراحی نمی‌کنم؛ برای کارکردن طراحی می‌کنم.»',
    '',
  ],
  skills: [
    '',
  ...
  projects: [
    ...
    '  010  NafasTools            — Next.js / TypeScript',
    '',
    '  → برای بررسی کارهای منتخب، آرشیو را مرور کنید.',
    '',
  ],
  contact: [
    '',
  ...
  coffee: [
    '',
    '  ☕  کافئین در حال بارگذاری...',
    '',
    '  ██████████████████████████████ 100%',
    '',
    '  کیفیت طراحی              +25%',
    '  دقت در جزئیات            +40%',
    '  حساسیت به کرنینگ فونت    +60%',
    '  تحمل بریف‌های بد         -15%',
    '',
    '  ✓ آمادهٔ طراحی.',
    '',
...
export const terminalContent = {
  ...
  fa: {
    ...
    boot: [
      ...
      '──────────────────────────────────────────',
      'برای دیدن فهرست فرمان‌ها «راهنما» یا help را تایپ کنید.',
      '',
    ],
    notFound: (cmd: string) =>
