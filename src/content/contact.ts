export const contactContent = {
  en: {
    ...
    footerRights: (year: number) =>
      `© ${year} DBS Graphic · Saeed Zarrini — All work reserved.`,
    footerTagline: 'Designing Trust Since 2007',
  },
  fa: {
    ghost: 'دی‌بی‌اس گرافیک',
    eyebrow: 'بخش ۰۴',
    headlineLead: 'طراحی همان نقطه‌ای است که',
    headlineAccent: 'اعتماد آغاز می‌شود.',
    paragraph:
      'برای همکاری دورکار یا پاره‌وقت آماده‌ام — در بسته‌بندی دارویی، هویت برند یا ساخت محصول سفارشی. گفت‌وگو را از مسئله‌ای شروع کنیم که باید در عمل دوام بیاورد.',
    emailLabel: 'ایمیل',
    phoneLabel: 'تلفن',
    email: 'zrn_sany@yahoo.com',
    phone: '09301221816',
    ...
    footerTagline: 'طراحی برای اعتماد از ۱۳۸۶',
  },
};
